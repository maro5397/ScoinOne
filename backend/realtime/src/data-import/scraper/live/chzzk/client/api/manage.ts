...
export class ChzzkManage {
  ...
  async temporaryRestrict(channelId: string, chatChannelId: string, targetId: string): Promise<PartialUser> {
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/temporary-restrict-users`, {
        method: 'POST',
  ...
  async restrict(channelId: string, targetId: string): Promise<PartialUser> {
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/restrict-users`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  async chatActivityCount(channelId: string, targetId: string): Promise<ChatActivtyCount> {
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/users/${targetId}/chat-activity-count`)
      .then((r) => r.json())
      .then((data) => data['content'] ?? null)
      .catch(() => null);
  }
  ...
  async setRole(
    channelId: string,
    targetId: string,
    userRoleType: 'streaming_chat_manager' | 'streaming_channel_manager',
  ): Promise<PartialUser> {
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/streaming-roles`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  async setting(channelId: string, params?: LiveSettingParams): Promise<LiveSetting> {
    ...
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/live-setting`, options)
      .then((r) => r.json())
      .then((data) => data['content'] ?? null);
  }
  ...
  async chatRule(channelId: string): Promise<ChatRule> {
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/chat-rules`)
      .then((r) => r.json())
      .then((data) => data['content'] ?? null);
  }
  ...
  async prohibitWords(channelId: string): Promise<ProhibitWord[]> {
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/chats/prohibit-words`)
      .then((r) => r.json())
      .then((data) => data['content'] ?? null)
  ...
  async stream(channelId: string): Promise<Stream> {
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/streams`)
      .then((r) => r.json())
      .then((data) => data['content'] ?? null)
      .catch(() => null);
  }
  ...
  async subscribers(channelId: string, options?: Partial<SubscriberSearchOptions>): Promise<Subscribers> {
    ...
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/subscribers?${params.toString()}`)
      .then((r) => r.json())
      .then((data) => data['content'] ?? null)
      .catch(() => null);
  }
  ...
  async followers(channelId: string, options?: Partial<FollowerSearchOptions>): Promise<Followers> {
    ...
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/followers?${params.toString()}`)
      .then((r) => r.json())
      .then((data) => data['content'] ?? null)
      .catch(() => null);
  }
  ...
  async videos(channelId: string, options?: Partial<ManageVideoSearchOptions>): Promise<ManageVideos> {
    ...
    return this.client
      .fetch(`/manage/v1/channels/${channelId}/videos?${params.toString()}`)
      .then((r) => r.json())
      .then((data) => data['content'] ?? null)
      .catch(() => null);
  }
